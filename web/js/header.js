...
function initMobileMenu() {
  ...
  function createsMenuLists(arr, wrap) {
    arr.forEach(function (el, i) {
      ...
      listItemElement.classList.add('unitLi'); // console.log(el.sublink)

      if (el.sublink) {
        // listItemElement.classList.add('mnuSub')
...
var submenuLists = []; // catalogButton.addEventListener('click', () => {
//     if (catalogButton && window.innerWidth <= 1199) {
...
document.addEventListener('click', function (e) {
  ...
  if (!e.target.closest('.nested-list') && !e.target.closest('.mobile-catalog-first-level') && !e.target.closest('.header__catalog') && isMobileCatalogVisible == true) {
    ...
    destroyCatalogDrop();
    isMobileCatalogVisible = false;
  } // if (e.target.closest('.header__catalog') && document.querySelector('.submenu3').classList.contains('active')) {
  //     document.querySelector('.submenu3').classList.remove('active')
  // }
...
document.addEventListener('click', function (e) {
  ...
  var contents = document.querySelectorAll('.hideSubs'); // console.log(targets)
